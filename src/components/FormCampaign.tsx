"use client";
import { CAMPAIGN_FIELDS, type FieldDef } from "@/lib/log-schemas";
...
export default function FormCampaign({ values, onChange }: Props) {
  const sections = groupBySection(CAMPAIGN_FIELDS);
